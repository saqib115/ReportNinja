...
public class WebService : System.Web.Services.WebService {
  ...
  public string btnLogIn_Click(string email, string password)
    ...
    public string SendEmailReport(string username, int userId, string reportGuid, string versionGuid, string reportName,string topPageGuid)
    {
        string EmailStatus = "";
        try
        {
            //string[] EmailAddresses = txtEmailReportEmails.Value.Trim().Split(',');
            string Emails = "mubbaram@hotmail.com";
